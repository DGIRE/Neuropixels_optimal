%% SIMPLE IMPORT.m  —  Neuropixels Simplified Data Import & Unit Location Plot
%
%   Reads path and settings from File paths.txt, loads one experiment's
%   LabView sensor, LFP, and spike data, then produces the unit-location
%   probe map (equivalent to Steps 1–3 of PIPELINE.m — no interactive
...
fprintf('================================================\n');
fprintf('  Neuropixels — Simple Import\n');
fprintf('================================================\n\n');
